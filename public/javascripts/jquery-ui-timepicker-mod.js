...
Timepicker.prototype = {
    init: function()
    {
        ...
        this.tpDiv      = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all" style="width:30em; display: none; position: absolute;"></div>'); 
        this._generateHtml();
    ...
    _generateHtml: function ()
    {
		...
		html += '<button class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="jQuery.datepicker._hideDatepicker();" type="button">Done</button>';
		html += '</div>';
