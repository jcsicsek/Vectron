...
class ScrapeOffoffonline
  ...
  def self.scrape_name(row)
    scraper = Scraper.define do
      process "html>body>table:nth-of-type(2) tr>td:nth-of-type(2)>table tr:nth-of-type(" + row.to_s + ")>td:nth-of-type(2)>b>a:nth-of-type(1)", :name => :text
      result :name
    end
  ...
  def self.scrape_shows
    ...
    image_url_scraper = Scraper.define do
      process 'html>body>table:nth-of-type(2) tr>td:nth-of-type(2)>table tr>td>table tr:nth-of-type(2)>td:nth-of-type(2)>a:nth-of-type(1)', :url => "@href"
      result :url
    end
    ...
    while uri
      ...
      image_url = "http://www.offoffonline.com/" + image_url_scraper.scrape(uri)
      ...
      misc_hash = {:show_url => show_url_scraper.scrape(uri), :ticket_url => ticket_url_scraper.scrape(uri), :external_id => external_id, :name => name, :image_url => image_url}
